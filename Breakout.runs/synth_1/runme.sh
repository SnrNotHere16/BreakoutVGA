...
HD_PWD='C:/Users/OAkun/Desktop/School/CECS361/Breakout/Breakout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vga_sync_alpha.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vga_sync_alpha.tcl
