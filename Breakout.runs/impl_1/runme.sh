...
HD_PWD='C:/Users/OAkun/Desktop/School/CECS361/Breakout/Breakout.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vga_sync_alpha.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vga_sync_alpha.tcl -notrace
